...
describe Velomemo::Period do
  ...
  describe "#includes?" do
    ...
    it "should return true when arg is nil" do
      subject.includes?(nil).should be_true
    end

    it "should return false when arg is before beginning of period" do
      subject.includes?(subject.begin - 1).should be_false
    end

    it "should return true when arg is equal to beginning of period" do
      subject.includes?(subject.begin).should be_true
    end

    it "should return true when arg is between beginning and end of period" do
      subject.includes?(subject.begin + 1).should be_true
    end

    it "should return true when arg is equal to end of period" do
      subject.includes?(subject.end).should be_true
    end

    it "should return false when arg is after end of period" do
